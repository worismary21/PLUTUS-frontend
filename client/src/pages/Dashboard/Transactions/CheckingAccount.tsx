  ...
  return (
    ...
    <div className="text-left lg:w-7/12 p-5 checkingaccount-black sm:max-lg:w-screen">
      ...
      <div className="flex-col p-2">
        ...
        <h2 className="text-blue-300">USD <span className="pl-2">{userDetails?.accountBalance || 0}</span></h2>
      ...
      <div className="flex p-2 justify-between">
        ...
        <h5 className="text-white">USD {income || '0'}</h5>     
        </div>
        <div>
        <h6 className="text-white text-xs">Expenses</h6>
        <h5 className="text-white">USD {expenses || ''}</h5>     
        </div>
