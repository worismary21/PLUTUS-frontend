  ...
  return <>
     <div className={change.changePassword}>
          ...
          <div className={change.rightSide}>
               ...
               {!modal &&<div className={change.content}>
                    <h2>Change Password</h2>
                    <p>Enter you email address</p>
                    <form action='' onSubmit={handleSubmit}>
                    <input className={change.inputEmail} type="email" placeholder='Email' name='email' value={email} required onChange={handleInputChange} ></input>
                    <button type='submit'>Submit</button>
                    </form>
               </div>}
               {modal && <div className={change.content1}>
                    <h2> Verify your identity</h2>
                    <p id='first'>
                    We've just sent an email with your security code to the email ogo_b*********.com
                    </p>
                    <p>
                    Please enter the code in other to continue 
                    </p>
                    <form>
               ...
               <div className={change.countdowntext}>
                    ...
                    <p>
                         ...
                         <button id='otp_resend' 
                         disabled={seconds > 0 || minutes > 5}
                         style={{
                              color: seconds > 0 || minutes > 0 ? "#fff" : "#FF5630"
                         }} onClick={resendOTP}>I didn't get the code</button>
                    </form>
               </div>}
          </div>
